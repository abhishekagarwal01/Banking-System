...
<body>
    ...
    <!-- Nav bar -->
    <nav class="navbar py-2 navbar-expand-lg navbar-light" style="background-color: #e3f2fd;">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">TSF Banking <img src="logos/bank.png" alt="Bank" width="50" height="50"></a>
    ...
    <class class="welcome">
        <h2 style="background-color:yellow;">
            <img src="logos/friend.webp" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Welcome to The Sparks Foundation Bank !</strong> <img src="logos/trust.webp" alt="Bank" width="75" height="75">
        </h2>
    </class>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="background/bg01.jpg" width="1000" height="375" class="d-block w-100" alt="...">

            </div>
            <div class="carousel-item">
                <img src="background/backg2.jpg" width="1000" height="375" class="d-block w-100" alt="...">
            ...
            <div class="col-md-6">
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <img class="bd-placeholder-img" width="350" height="300" src="background/moneyTransfer.png" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <div class="service">
                            <ul>
                                ...
                                <li>Work for your satisfaction</li>
                                <li>Are 24 x 7 available, i.e, always in your service</li>
                            </ul>
                        </div>
                        </p>
                    </div>
                    <div class="col-auto d-none d-lg-block">
                        <img class="bd-placeholder-img" width="350" height="300" src="background/transHistory.png" alt="">
                    </div>
                </div>
            </div>
        </div>
