...
<body>
    ...
    <class class="welcome" style="background-color = white;">
        <h2 style="background-color = white;">
            <img src="logos/friend.webp" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>We are happy to help you !</strong> <img
